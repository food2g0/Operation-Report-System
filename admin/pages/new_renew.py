...
New & Renew Page
────────────────
Tracks Jewelry and Storage Empeno with NEW and RENEW breakdown.
Pulls data from daily_reports_brand_a.
Columns: Branch | Jew NEW Lotes | Jew NEW Capital | Jew RENEW Lotes | Jew RENEW Capital
                | Sto NEW Lotes | Sto NEW Capital | Sto RENEW Lotes | Sto RENEW Capital
"""
...
from admin.db_worker import run_query_async
...
COLUMNS = [
    ...
    ("JEW. RENEW\nLotes",   ["empeno_jew_renew_lotes"],          True),
    ("JEW. RENEW\nCapital", ["empeno_jew_renew"],                False),
    ("STO. NEW\nLotes",     ["empeno_sto_new_lotes"],            True),
    ("STO. NEW\nCapital",   ["empeno_sto_new"],                  False),
    ("STO. RENEW\nLotes",   ["fund_empeno_sto_renew_lotes"],     True),
    ("STO. RENEW\nCapital", ["fund_empeno_sto_renew"],           False),
]
...
COL_COLORS = {
    ...
    1: QColor("#dc3545"),  # Jew New Lotes
    2: QColor("#dc3545"),  # Jew New Capital
    3: QColor("#c0392b"),  # Jew Renew Lotes
    4: QColor("#c0392b"),  # Jew Renew Capital
    5: QColor("#e67e22"),  # Sto New Lotes
    6: QColor("#e67e22"),  # Sto New Capital
    7: QColor("#d35400"),  # Sto Renew Lotes
    8: QColor("#d35400"),  # Sto Renew Capital
}
...
class NewRenewPage(QWidget):
    """New & Renew — Jewelry and Storage Empeno (NEW + RENEW) per branch."""
    ...
    def populate_table(self):
        ...
        run_query_async(
            ...
            loading_message="\u23f3  Loading renew data\u2026",
        )
