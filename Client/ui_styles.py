...
# Richer, higher-contrast colours used across the client
_BLUE_600   = "#2563EB"
_BLUE_700   = "#1D4ED8"
_BLUE_50    = "#EFF6FF"
_BLUE_100   = "#DBEAFE"
...
QLineEdit {{
    ...
    selection-background-color: {_BLUE_100};
    selection-color: {_BLUE_700};
}}
QLineEdit:focus {{
    border: 2px solid {_BLUE_600};
    background-color: {_BLUE_50};
...
/* ── Buttons ─────────────────────────────────────────────────────────────── */
QPushButton {{
    background-color: {_BLUE_600};
    color: #FFFFFF;
    border: none;
    padding: {_sz(8)}px {_sz(18)}px;
    border-radius: {_sz(7)}px;
    font-family: {_FONT};
    font-size: {_sz(12)}px;
    font-weight: 700;
    min-width: {_sz(80)}px;
...
QPushButton:hover   {{ background-color: {_BLUE_700}; }}
...
QScrollBar:vertical {{
    background: transparent; width: 6px; border-radius: 3px; margin: 2px 0;
}}
QScrollBar::handle:vertical {{
    background: {_SLATE_300}; border-radius: 3px; min-height: 28px;
}}
...
QDateEdit:focus {{ border: 2px solid {_BLUE_600}; background-color: {_BLUE_50}; padding: {_sz(6)}px {_sz(9)}px; }}
QDateEdit::drop-down {{
...
QDateEdit::drop-down:hover {{ background-color: {_BLUE_100}; }}
